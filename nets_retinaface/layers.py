...
#---------------------------------------------------#
def conv_bn_relu1X1(inp, oup, stride, leaky=0):
...
class FPN(nn.Module):
    def __init__(self, in_channels_list, out_channels):
        ...
        #-------------------------------------------#
        self.output1 = conv_bn_relu1X1(in_channels_list[0], out_channels, stride = 1, leaky = leaky)
        self.output2 = conv_bn_relu1X1(in_channels_list[1], out_channels, stride = 1, leaky = leaky)
        self.output3 = conv_bn_relu1X1(in_channels_list[2], out_channels, stride = 1, leaky = leaky)
